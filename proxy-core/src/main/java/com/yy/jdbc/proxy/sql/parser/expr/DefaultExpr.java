...
public class DefaultExpr extends SQLExpression {

	public DefaultExpr(TExpression expr) {
		super(expr.getExpressionType(), null, expr);
	}

	
	@Override
	public Multimap<String, String> getFieldsWithTablePrefix() throws SQLException {
		Multimap<String, String> resultMap =
				getTableFieldsWithTablePrefix(expr);
		return resultMap;
	}
	@Override
	public Multimap<String, String> getFieldsWithoutTablePrefix() throws SQLException {
		Multimap<String, String> resultMap = 
				getTableFieldsWithoutTablePrefix(expr);
		return resultMap;
	}
